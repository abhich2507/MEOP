...
\begin{frame}{Decay Amplitude $P_0$ vs Laser Power}
  \begin{center}
    \includegraphics[width=0.92\textwidth]{power_vs_P0.png}
  \end{center}
  \vspace{-4mm}
  \footnotesize
...
\begin{frame}{Buildup Time Constant $\tau_b$ vs Laser Power}
  \begin{center}
    \includegraphics[width=0.92\textwidth]{power_vs_tau_b.png}
  \end{center}
  \vspace{-4mm}
  \footnotesize
  Error bars: $\sigma_{\mathrm{total}} = \sqrt{\sigma_{\mathrm{fit}}^2 + \sigma_{\mathrm{rms}}^2}$
...
% ---- Slide 3: C8 vs C9 Comparison ----
\begin{frame}{C8 vs C9 Comparison}
  \begin{center}
    \includegraphics[width=0.92\textwidth]{C8_vs_C9_comparison.png}
  \end{center}
  \vspace{-4mm}
  \footnotesize
