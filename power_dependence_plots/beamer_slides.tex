...
% Push footnote text above the Madrid footer bar
\addtobeamertemplate{footnote}{}{\vspace{2ex}}
\newcommand{\plotnote}[1]{%
  \vfill
  {\usebeamercolor[fg]{structure}\scriptsize #1}%
}
...
% ---- Slide 1: tau_b vs Power ----
\begin{frame}{Buildup Time Constant $\tau_b$ vs Laser Power}
  \begin{center}
    \includegraphics[width=0.70\textwidth]{power_vs_tau_b.png}
  \end{center}
  \plotnote{Error bars: $\sigma_{\mathrm{total}} = \sqrt{\sigma_{\mathrm{fit}}^2 + \sigma_{\mathrm{rms}}^2}$ \hfill Faded points = individual datagrabs}
\end{frame}

%---- Slide 2: P_max vs Power ----
\begin{frame}{Maximum Polarization $P_{\rm max}$ vs Laser Power}
  \begin{center}
    \includegraphics[width=0.70\textwidth]{power_vs_Pmax.png}
  \end{center}
  \plotnote{Error bars: $\sigma_{\mathrm{total}} = \sqrt{\sigma_{\mathrm{fit}}^2 + \sigma_{\mathrm{rms}}^2}$ \hfill Faded points = individual datagrabs}
\end{frame}
...
\begin{frame}{Decay Time Constant $\tau_{\mathrm{decay}}$ vs Laser Power}
  \begin{center}
    \includegraphics[width=0.70\textwidth]{power_vs_tau_decay.png}
  \end{center}
  \plotnote{Error bars: $\sigma_{\mathrm{total}} = \sqrt{\bar{\sigma}_{\mathrm{fit}}^2 + \sigma_{\mathrm{rms}}^2}$,\;
  $\bar{\sigma}_{\mathrm{fit}} = \sqrt{\sum\sigma_{\mathrm{fit},i}^2}/N$ \hfill Faded points = individual datagrabs}
\end{frame}
